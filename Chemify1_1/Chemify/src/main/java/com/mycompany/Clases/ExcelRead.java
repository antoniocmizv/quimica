...
public class ExcelRead {
    ...
    public static void insertarSalas() {
        try {
            ...
            FileInputStream file = new FileInputStream(new File("src/main/java/com/mycompany/excels/datos.xlsx"));
    ...
    public static void insertarQuimicos() {
        try {
            ...
            String sql = "INSERT INTO quimicos " +
                    "(Id_Quimico,Pureza,Fecha_Caducidad,Id_Producto,Id_Formato,Id_Riesgo,riesgosNombres)" +
                    " VALUES (?,?,?,?,?,?,?)";
            PreparedStatement ps = connection.prepareStatement(sql);
            ...
            for (Row row : sheet) {
                ...
                String riesgosNombres = row.getCell(6).getStringCellValue();
                ...
                ps.setString(7, riesgosNombres);

                ps.executeUpdate();
                System.out.println("Se inserto: " + idQuimico + " " + pureza + " " + fechaCaducidad + " " +
                        idProducto + " " + idFormato + " " + idRiesgo+ " " + riesgosNombres);
            }
    ...
    public static void insertarRiesgos() {
        try {
            ...
            for (Row row : sheet) {
                ...
                String nombreRiesgo = row.getCell(0).getStringCellValue();
